  ...
  $.ajax({
      ...
      success: function (data) {
        ...
        if (data.code == '100') {
        	...
        	$(".content .jumbotron").html("<h3>liKeYun短链接2.0安装成功！</h3><p><a href='../index/' target='blank'>管理后台>&nbsp;&nbsp;&nbsp;</a> <a href='../index/creat.php' target='blank'>快捷生成页> </a>&nbsp;&nbsp;&nbsp;<a href='http://www.liketube.cn/ma/common/qun/redirect/?hmid=19122' target='blank'>加入交流群></a> </p>");
        }else{
